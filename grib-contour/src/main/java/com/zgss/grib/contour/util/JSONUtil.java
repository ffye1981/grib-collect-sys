...
public class JSONUtil {
	...
	public static Object toObjectWithNumStr2Mum(String jsonString, Class<?> beanClass) throws Exception{
		//mapperNumbAsString
		Object obj = "";
		try {
	...
	public static List<?> toListWithNumStr2Mum(String jsonString, Class<?> beanClass) throws Exception {
		List<?> list = null;
		TypeFactory factory = TypeFactory.defaultInstance();
		try {
