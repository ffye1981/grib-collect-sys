...
public class FileUtil {
    ...
    public static String readFile(String file) {
        ...
        try {
            ...
            result =  readFile(fileInputStream);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return result;
     ...
     * @return
     */
    public static boolean makeDirectory(String file) {
        // 创建目录
        if (!isFileExist(file)) {
    ...
    public static File[] list(String path,final String prefix){
    ...
    public static String[] listNames(String path,final String prefix){
        File file = new File(path);
        if (file.isFile())
            return null;
